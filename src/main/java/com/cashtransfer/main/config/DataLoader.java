     ...
     * This runner is activated only when the "dev" or "postgres" Spring profile is active.
     */
    @Component
    @Profile({"dev", "postgres", "h2"}) // Activate this loader for 'dev' or 'postgres' profiles
    public class DataLoader implements CommandLineRunner {
        ...
        /**
         * This method runs automatically after the Spring ApplicationContext is loaded.
         * It checks if data already exists and, if not, creates mock users and accounts.
         *
        ...
        public void run(String... args) throws Exception {
            ...
            if (userRepository.count() == 0) {
                ...
                // The @AllArgsConstructor in User model expects all fields, including 'account'.
                // Since account is a MappedCollection and will be created separately, pass null here.
                ...
                logger.info("Created users: {}, {}, {}", alice, bob, admin);

                // Create and save Accounts linked to Users
                // Ensure that the user_id corresponds to the saved user's actual ID
                // The @AllArgsConstructor in Account model expects the 'id' field as the first argument.
                ...
                logger.info("Mock data loaded successfully. Total users: {}, Total accounts: {}",
